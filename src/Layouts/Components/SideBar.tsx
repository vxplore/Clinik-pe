  ...
  return (
    ...
    >
      <div className="sidebarHeader p-4">
        <Link to="/">
          <Image src="/images/logo.webp" alt="Logo" width="220" height="54" className="logoBig"/>
          <Image src="/images/logo-fav.webp" alt="Logo" width="75" height="75" className="logoSmall"/>
        </Link>
        <div className="mt-2 pl-[7px]">
          <Button className="!p-2 !bg-[rgba(255,255,255,0.05)] rounded-full flex justify-center items-center w-[40px] h-[40px] menuBar" leftSection={
            <>
      ...
      <nav className="overflow-auto p-4 sidebarNav flex flex-col gap-2" onClick={() => {
        if (isSmall) {
          setIsSmall(false);
        }
      }}>
        <NavLink
          leftSection={
            <>
              <Image src="/images/icons/dashboard.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         ...
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/appointments.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         ...
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/lab-test-request.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Lab Test Request" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/patients.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Patients" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/charting.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Charting" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/diagnostic.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Diagnostic" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/reports.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Reports" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/payments.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Payments" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/provider-payout.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Provider Payout" />
         <NavLink
          leftSection={
            <>
              <Image src="/images/icons/settings.svg" height="26px" width="26px" className="h-[26px] w-[26px]" />
            </>
          }
         href="#" label="Settings">
