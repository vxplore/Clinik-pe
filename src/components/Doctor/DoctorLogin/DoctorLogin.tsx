...
export default function DoctorLogin() {
  ...
  const handleSendOtp = () => {
    ...
    setTimeout(() => {
      ...
      notifications.show({
        title: "OTP Sent",
        message: `A 6-digit code was sent to +91-${mobile.slice(
          0,
          2
        )}xxxx${mobile.slice(-2)}.`,
        color: "green",
                ...
                >
                  <i>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M2 18.5215H16C17.103 18.5215 18 17.6245 18 16.5215V7.85348L16 9.85348V16.5215H5.158C5.132 16.5215 5.105 16.5315 5.079 16.5315C5.046 16.5315 5.013 16.5225 4.979 16.5215H2V2.52148H8.847L10.847 0.521484H2C0.897 0.521484 0 1.41848 0 2.52148V16.5215C0 17.6245 0.897 18.5215 2 18.5215Z"
                        fill="#74777E"
                      />
                    </svg>
                  </i>
